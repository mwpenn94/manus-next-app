...
Call log:
  ...
  - waiting for locator('nav[aria-label="Main navigation"]').getByText('Analytics')
    14 × locator resolved to <a href="/analytics" data-loc="client/src/components/AppLayout.tsx:611" class="flex items-center gap-2.5 px-3 py-2.5 md:py-2 rounded-md text-sm transition-colors active:scale-[0.98] text-muted-foreground hover:text-sidebar-foreground hover:bg-sidebar-accent/50">…</a>
