...
- Name: authenticated.auth.spec.ts >> Authenticated: Task Creation & Persistence >> creating a task navigates to task page
- Location: e2e/authenticated.auth.spec.ts:95:3
...
Expected substring: "/task/"
Received string:    "https://manus.im/app-auth?appId=mLRoMfUBgPHZe3zeGnUGcR&redirectUri=http%3A%2F%2Flocalhost%3A3000%2Fapi%2Foauth%2Fcallback&state=aHR0cDovL2xvY2FsaG9zdDozMDAwL2FwaS9vYXV0aC9jYWxsYmFjaw%3D%3D&type=signIn"
```
...
- generic [active] [ref=e1]:
  ...
  - separator [ref=e5]
  - generic [ref=e6]: "Generated by cloudfront (CloudFront) Request ID: 2ym4HRpVg2fJMyEkOEZxejyw2oQqgYNbGWEsQqQ4EzvHjsofBmHU3A=="
```
