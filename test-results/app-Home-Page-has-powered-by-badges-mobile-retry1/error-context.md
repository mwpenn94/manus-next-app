...
- Name: app.spec.ts >> Home Page >> has powered-by badges
...
Call log:
  ...
  - waiting for getByText('POWERED BY')
    14 × locator resolved to <span data-loc="client/src/pages/Home.tsx:455" class="text-[10px] text-muted-foreground mr-1.5 uppercase tracking-wider">Powered by</span>
