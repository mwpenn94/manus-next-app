...
- Name: app.spec.ts >> Sidebar Navigation >> sidebar nav is visible on desktop
- Location: e2e/app.spec.ts:89:3
...
Call log:
  ...
  - waiting for locator('nav[aria-label="Main navigation"]')
    14 × locator resolved to <nav aria-label="Main navigation" data-loc="client/src/components/AppLayout.tsx:1022" class="hidden md:flex flex-col border-r border-sidebar-border bg-sidebar transition-all duration-200 w-[280px]">…</nav>
