...
> Per §E: For every capability at GREEN, define a concrete "exceed" target that would push Manus Next beyond Manus Pro parity. For RED capabilities, define the path to GREEN plus the exceed target.

**Last updated:** April 19, 2026 | **Capabilities covered:** 67/67
...
| 2 | Agent Mode | GREEN | Checkpoint/resume for tasks spanning hours, parallel tool execution | 12h | Complex task completion |
...
| # | Capability | Status | Exceed Target | Effort |
|---|-----------|--------|---------------|--------|
| 11 | Projects | GREEN | Project templates, auto-generated project briefs from conversation history | 8h |
| 12 | Manus Skills | GREEN | Community skill marketplace with ratings, reviews, and one-click install | 30h |
| 13 | Agent Skills | GREEN | Auto-discover skills from GitHub repos, version management, skill composition | 25h |
| 14 | Project Skills | GREEN | Skill analytics (usage, success rate), auto-suggest skills per project type | 15h |
| 15 | Design View | GREEN | AI-powered layout suggestions, component library, export to Figma | 20h |
| 16 | Manus Slides | GREEN | Real-time collaborative editing, presenter mode, export to PPTX/PDF | 20h |
...
| 20 | Mail Manus | GREEN | AI email drafting, smart reply, email analytics, thread summarization | 15h |
| 21 | Meeting Minutes | GREEN | Real-time transcription, action item extraction, calendar integration | 10h |

## Browser + Computer (Caps 22-26)

| # | Capability | Status | Exceed Target | Effort |
|---|-----------|--------|---------------|--------|
| 22 | Cloud Browser | GREEN | Multi-tab browsing, session persistence, cookie management, proxy rotation | 20h |
| 23 | Browser Operator | GREEN | Record-and-replay macros, visual element selection, form auto-fill | 15h |
| 24 | Screenshot verification | GREEN | Visual diff testing, layout regression detection, accessibility overlay | 10h |
| 25 | Computer Use | GREEN | Multi-monitor support, application-specific macros, real OS control via bridge | 30h |
...
| # | Capability | Status | Exceed Target | Effort |
|---|-----------|--------|---------------|--------|
| 27 | Web-app creation | GREEN | AI-driven full-stack generation from natural language spec, component library | 20h |
| 28 | Live preview | GREEN | Direct visual editing (click-to-edit), responsive preview at multiple breakpoints | 15h |
| 29 | Publishing | GREEN | One-click deploy to custom domains, A/B testing, rollback with traffic splitting | 10h |
...
| 34 | Payments | GREEN | Subscription management, usage-based billing, invoice generation, revenue analytics | 15h |
...
| 36 | Custom Domains | GREEN | Automatic SSL provisioning, DNS management, subdomain routing | 5h |
...
| # | Capability | Status | Path to GREEN | Exceed Target | Effort |
|---|-----------|--------|---------------|---------------|--------|
| 49 | Connectors | GREEN | — | Visual connector builder, data mapping UI, error retry with backoff | 20h |
| 50 | MCP | GREEN | — | MCP marketplace, auto-discovery, protocol versioning | 15h |
| 51 | Slack | GREEN | — | Slash commands, interactive messages, channel-specific agents | 10h |
| 52 | Messaging Agent | GREEN | — | Multi-platform threading, conversation memory, platform-specific rich messages | 15h |
| 53 | Microsoft 365 | RED | Enterprise Microsoft Graph API integration | SharePoint, OneDrive, Outlook, Teams deep integration | 40h |
| 54 | GoHighLevel | N/A | — | — | — |
| 55 | Meta Ads | N/A | — | — | — |
| 65 | Zapier | GREEN | — | Bi-directional triggers, Zap templates, usage analytics | 8h |

## Collaboration + Team (Caps 56-58)

| # | Capability | Status | Exceed Target | Effort |
|---|-----------|--------|---------------|--------|
| 56 | Collab | GREEN | Cursor presence, collaborative editing, role-based permissions per task | 15h |
| 57 | Team Billing | GREEN | Usage-based billing per team member, cost allocation, budget alerts | 12h |
| 58 | Shared Session | GREEN | Session handoff, spectator mode, session recording for training | 10h |
...
| 62 | Veo3 Video | RED | Text-to-video with style transfer, video editing, multi-clip composition | 30h |
