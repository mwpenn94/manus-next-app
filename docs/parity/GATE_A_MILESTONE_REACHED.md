...
| Convergence cycles | 3 (CP-26/27/28) | 3 consecutive |
...
4. **CP-33/34/35** (Session 4): Fourth convergence — judge v3 (60/72 passing)
5. **CP-39/40/41** (Session 4): Fifth convergence — judge v9 (72/72 passing, 100%)
