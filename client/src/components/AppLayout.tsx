...
function AppsGridMenu({ location }: { location: string }) {
  ...
  const items: Array<{ href: string; label: string; Icon: typeof FolderOpen; color: string }> = useMemo(() => {
    const all: Array<{ href: string; label: string; Icon: typeof FolderOpen; color: string }> = [
      ...
      { href: "/browser", label: "Browser", Icon: Compass, color: "text-blue-400" },
      { href: "/inference", label: "Inference", Icon: Cpu, color: "text-violet-400" },
      { href: "/computer-use", label: "Computer Use", Icon: Monitor, color: "text-teal-400" },
      { href: "/devices", label: "Devices", Icon: Smartphone, color: "text-green-400" },
      { href: "/data-analysis", label: "Data Analysis", Icon: FileSearch, color: "text-orange-400" },
      { href: "/data-pipelines", label: "Data Pipelines", Icon: Database, color: "text-blue-400" },
      { href: "/deep-research", label: "Deep Research", Icon: Search, color: "text-purple-400" },
      { href: "/desktop", label: "Desktop App", Icon: Laptop, color: "text-slate-400" },
      { href: "/documents", label: "Documents", Icon: FileText, color: "text-amber-400" },
      { href: "/figma", label: "Figma Import", Icon: Figma, color: "text-pink-400" },
      { href: "/mail", label: "Mail", Icon: Mail, color: "text-sky-400" },
      { href: "/meetings", label: "Meetings", Icon: CalendarDays, color: "text-indigo-400" },
      { href: "/messaging", label: "Messaging", Icon: MessageSquare, color: "text-green-400" },
      { href: "/mobile-projects", label: "Mobile", Icon: Smartphone, color: "text-rose-400" },
      { href: "/music", label: "Music Studio", Icon: Music, color: "text-fuchsia-400" },
      { href: "/qa-testing", label: "QA Testing", Icon: TestTube2, color: "text-lime-400" },
      { href: "/slides", label: "Slides", Icon: Presentation, color: "text-orange-400" },
      { href: "/sovereign", label: "Sovereign AI", Icon: Shield, color: "text-emerald-400" },
      { href: "/video", label: "Video", Icon: Video, color: "text-red-400" },
      { href: "/webapp-builder", label: "Web Apps", Icon: Rocket, color: "text-cyan-400" },
      { href: "/deployed-websites", label: "Deployed Sites", Icon: Globe, color: "text-blue-400" },
      { href: "/publish", label: "Publish", Icon: ExternalLink, color: "text-green-400" },
    ];
    if (userRole === "admin") {
      all.push(
