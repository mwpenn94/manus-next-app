...
const MOCK_STEPS: TaskStep[] = [
  {
    ...
    description: "Analyzing the user's intent and breaking down requirements",
    status: "completed",
    duration: "2s",
    subSteps: [
      { id: "s1a", label: "Parse natural language input", status: "completed", duration: "0.8s" },
      { id: "s1b", label: "Identify key entities and actions", status: "completed", duration: "0.6s" },
      { id: "s1c", label: "Generate task plan", status: "completed", duration: "0.6s" },
    ],
  },
  {
    id: "s2",
    label: "Research & Information Gathering",
    description: "Searching the web and gathering relevant information",
    status: "completed",
    duration: "8s",
    toolsUsed: ["Web Search", "Browse Website"],
    subSteps: [
      { id: "s2a", label: "Search for React 19 documentation", status: "completed", duration: "1.2s" },
      { id: "s2b", label: "Browse official React blog", status: "completed", duration: "3.4s" },
      { id: "s2c", label: "Extract relevant code examples", status: "completed", duration: "2.1s" },
      { id: "s2d", label: "Cross-reference with migration guide", status: "completed", duration: "1.3s" },
    ],
  },
  {
    id: "s3",
    label: "Code Generation",
    description: "Writing the component code based on gathered information",
    status: "running",
    toolsUsed: ["Code Generation", "File Write"],
    subSteps: [
      { id: "s3a", label: "Generate component skeleton", status: "completed", duration: "1.1s" },
      { id: "s3b", label: "Implement useOptimistic hook", status: "completed", duration: "2.3s" },
      { id: "s3c", label: "Add error handling and loading states", status: "running", detail: "Writing error boundary..." },
      { id: "s3d", label: "Write unit tests", status: "pending" },
      { id: "s3e", label: "Add TypeScript types", status: "pending" },
    ],
  },
  {
    id: "s4",
    label: "Verification & Testing",
    description: "Running tests and verifying the implementation",
    status: "pending",
    toolsUsed: ["Terminal", "Browser"],
    subSteps: [
      { id: "s4a", label: "Run TypeScript compiler", status: "pending" },
      { id: "s4b", label: "Execute unit tests", status: "pending" },
      { id: "s4c", label: "Check for accessibility issues", status: "pending" },
    ],
  },
  {
    id: "s5",
    label: "Delivery",
    description: "Presenting the results and documentation",
    status: "pending",
    subSteps: [
      { id: "s5a", label: "Format code output", status: "pending" },
      { id: "s5b", label: "Generate usage documentation", status: "pending" },
    ],
  },
];
